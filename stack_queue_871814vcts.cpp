// Auto-generated: 2026-05-11 11:57:51
// Topic: Stack and Circular Queue
#include <iostream>
#include <vector>
#include <stdexcept>

namespace ds_871814vcts {
...
int main() {
    ds_871814vcts::Stack<int> stk;
    for(int x:{ 90, 1, 15, 89, 74, 20, 16 }) stk.push(x);
    std::cout<<"Stack top: "<<stk.peek()<<" size: "<<stk.size()<<"\n";
    ds_871814vcts::CQueue<int> q(20);
    for(int x:{ 90, 1, 15, 89, 74, 20, 16 }) q.enqueue(x);
