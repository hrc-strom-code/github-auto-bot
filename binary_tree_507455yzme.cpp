// Auto-generated: 2026-05-11 17:08:27
// Topic: Binary Search Tree — Insert, Search, Traversal
#include <iostream>
#include <memory>
#include <queue>

namespace bst_507455yzme {
...
int main() {
    std::shared_ptr<bst_507455yzme::Node> root;
    for(int x:{ 3, 97, 26, 18, 79, 57, 13, 48 }) root=bst_507455yzme::insert(root,x);
    std::cout<<"Inorder:     "; bst_507455yzme::inorder(root); std::cout<<"\n";
    std::cout<<"Level order: "; bst_507455yzme::level_order(root); std::cout<<"\n";
    return 0;
}
