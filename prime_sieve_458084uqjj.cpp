// Auto-generated: 2026-05-10 10:34:18
// Topic: Sieve of Eratosthenes
#include <iostream>
#include <vector>
#include <cmath>

namespace primes_458084uqjj {
...
int main() {
    auto primes=primes_458084uqjj::sieve(49);
    std::cout<<"Primes up to 49: "; for(int p:primes) std::cout<<p<<" "; std::cout<<"\n";
    int n=8*7;
    std::cout<<"Factors of "<<n<<": ";
    for(int f:primes_458084uqjj::factorize(n)) std::cout<<f<<" "; std::cout<<"\n";
    return 0;
}
