// Auto-generated: 2026-05-10 10:35:21
// Topic: Merge Sort
#include <iostream>
#include <vector>

namespace merge_521277yiks {
...
int main() {
    std::vector<int> arr = { 90, 85, 22, 96, 30, 48, 39, 81, 61, 23 };
    std::cout<<"Before: "; merge_521277yiks::print(arr);
    merge_521277yiks::sort(arr,0,arr.size()-1);
    std::cout<<"After:  "; merge_521277yiks::print(arr);
    return 0;
}
