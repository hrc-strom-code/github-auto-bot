// Auto-generated: 2026-05-10 10:35:16
// Topic: Sieve of Eratosthenes
#include <iostream>
#include <vector>
#include <cmath>

namespace primes_516025plos {
...
int main() {
    auto primes=primes_516025plos::sieve(52);
    std::cout<<"Primes up to 52: "; for(int p:primes) std::cout<<p<<" "; std::cout<<"\n";
    int n=11*7;
    std::cout<<"Factors of "<<n<<": ";
    for(int f:primes_516025plos::factorize(n)) std::cout<<f<<" "; std::cout<<"\n";
    return 0;
}
