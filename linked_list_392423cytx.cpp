// Auto-generated: 2026-05-10 10:33:12
// Topic: Singly Linked List with Reverse
#include <iostream>
#include <memory>

namespace linked_list_392423cytx {
...
int main() {
    linked_list_392423cytx::List<int> lst;
    for(int x:{ 25, 4, 61, 23, 66, 69, 64, 40, 95, 50 }) lst.push_back(x);
