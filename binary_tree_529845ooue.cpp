// Auto-generated: 2026-05-10 10:35:29
// Topic: Binary Search Tree — Insert, Search, Traversal
#include <iostream>
#include <memory>
#include <queue>

namespace bst_529845ooue {
...
int main() {
    std::shared_ptr<bst_529845ooue::Node> root;
    for(int x:{ 51, 49, 79, 97, 88, 38, 74 }) root=bst_529845ooue::insert(root,x);
    std::cout<<"Inorder:     "; bst_529845ooue::inorder(root); std::cout<<"\n";
    std::cout<<"Level order: "; bst_529845ooue::level_order(root); std::cout<<"\n";
    return 0;
}
