...
int main() {
    ds_856799khnk::Stack<int> stk;
    for(int x:{ 15, 3, 39, 82, 95, 67, 46 }) stk.push(x);
    std::cout<<"Stack top: "<<stk.peek()<<" size: "<<stk.size()<<"\n";
    ds_856799khnk::CQueue<int> q(20);
    for(int x:{ 15, 3, 39, 82, 95, 67, 46 }) q.enqueue(x);
