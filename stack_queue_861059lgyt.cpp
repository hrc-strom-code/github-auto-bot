...
int main() {
    ds_861059lgyt::Stack<int> stk;
    for(int x:{ 24, 41, 78, 51, 9, 16, 30, 48 }) stk.push(x);
    std::cout<<"Stack top: "<<stk.peek()<<" size: "<<stk.size()<<"\n";
    ds_861059lgyt::CQueue<int> q(20);
    for(int x:{ 24, 41, 78, 51, 9, 16, 30, 48 }) q.enqueue(x);
