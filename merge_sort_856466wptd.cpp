...
int main() {
    std::vector<int> arr = { 73, 78, 80, 91, 76, 2 };
    std::cout<<"Before: "; merge_856466wptd::print(arr);
    merge_856466wptd::sort(arr,0,arr.size()-1);
    std::cout<<"After:  "; merge_856466wptd::print(arr);
    return 0;
}
