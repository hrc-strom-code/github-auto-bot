// Auto-generated: 2026-05-10 10:36:53
// Topic: Merge Sort
#include <iostream>
#include <vector>

namespace merge_613202jtwp {
...
int main() {
    std::vector<int> arr = { 68, 24, 53, 44, 78, 11, 61, 73, 74 };
    std::cout<<"Before: "; merge_613202jtwp::print(arr);
    merge_613202jtwp::sort(arr,0,arr.size()-1);
    std::cout<<"After:  "; merge_613202jtwp::print(arr);
    return 0;
}
