...
int main() {
    ds_870024iraz::Stack<int> stk;
    for(int x:{ 42, 35, 22, 85, 88, 78, 81, 48, 74 }) stk.push(x);
    std::cout<<"Stack top: "<<stk.peek()<<" size: "<<stk.size()<<"\n";
    ds_870024iraz::CQueue<int> q(20);
    for(int x:{ 42, 35, 22, 85, 88, 78, 81, 48, 74 }) q.enqueue(x);
