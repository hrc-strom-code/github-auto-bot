// Auto-generated: 2026-05-10 10:33:59
// Topic: Sieve of Eratosthenes
#include <iostream>
#include <vector>
#include <cmath>

namespace primes_439951lpve {
...
int main() {
    auto primes=primes_439951lpve::sieve(32);
    std::cout<<"Primes up to 32: "; for(int p:primes) std::cout<<p<<" "; std::cout<<"\n";
    int n=10*7;
    std::cout<<"Factors of "<<n<<": ";
    for(int f:primes_439951lpve::factorize(n)) std::cout<<f<<" "; std::cout<<"\n";
    return 0;
}
