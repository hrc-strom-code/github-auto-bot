...
int main() {
    std::shared_ptr<bst_867321zops::Node> root;
    for(int x:{ 56, 43, 35, 30, 43, 58, 89 }) root=bst_867321zops::insert(root,x);
    std::cout<<"Inorder:     "; bst_867321zops::inorder(root); std::cout<<"\n";
    std::cout<<"Level order: "; bst_867321zops::level_order(root); std::cout<<"\n";
    return 0;
}
