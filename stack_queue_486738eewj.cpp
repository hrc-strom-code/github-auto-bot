// Auto-generated: 2026-05-10 10:34:46
// Topic: Stack and Circular Queue
#include <iostream>
#include <vector>
#include <stdexcept>

namespace ds_486738eewj {
...
int main() {
    ds_486738eewj::Stack<int> stk;
    for(int x:{ 39, 23, 17, 40, 68, 68, 39 }) stk.push(x);
    std::cout<<"Stack top: "<<stk.peek()<<" size: "<<stk.size()<<"\n";
    ds_486738eewj::CQueue<int> q(20);
    for(int x:{ 39, 23, 17, 40, 68, 68, 39 }) q.enqueue(x);
