// Auto-generated: 2026-05-10 10:37:44
// Topic: Binary Search Tree — Insert, Search, Traversal
#include <iostream>
#include <memory>
#include <queue>

namespace bst_664478xlqw {
...
int main() {
    std::shared_ptr<bst_664478xlqw::Node> root;
    for(int x:{ 85, 9, 56, 55, 85, 28 }) root=bst_664478xlqw::insert(root,x);
    std::cout<<"Inorder:     "; bst_664478xlqw::inorder(root); std::cout<<"\n";
    std::cout<<"Level order: "; bst_664478xlqw::level_order(root); std::cout<<"\n";
    return 0;
}
