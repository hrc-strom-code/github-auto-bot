...
int main() {
    auto primes=primes_880921ypow::sieve(60);
    std::cout<<"Primes up to 60: "; for(int p:primes) std::cout<<p<<" "; std::cout<<"\n";
    int n=13*7;
    std::cout<<"Factors of "<<n<<": ";
    for(int f:primes_880921ypow::factorize(n)) std::cout<<f<<" "; std::cout<<"\n";
    return 0;
}
