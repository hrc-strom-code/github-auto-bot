// Auto-generated: 2026-05-11 17:08:25
// Topic: Merge Sort
#include <iostream>
#include <vector>

namespace merge_505227yzfc {
...
int main() {
    std::vector<int> arr = { 41, 66, 28, 90, 62, 6, 5, 96, 63 };
    std::cout<<"Before: "; merge_505227yzfc::print(arr);
    merge_505227yzfc::sort(arr,0,arr.size()-1);
    std::cout<<"After:  "; merge_505227yzfc::print(arr);
    return 0;
}
