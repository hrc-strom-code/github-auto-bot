// Auto-generated: 2026-05-10 10:36:11
// Topic: Binary Search & Linear Search
#include <iostream>
#include <vector>
#include <algorithm>

namespace search_571114qbmj {
...
int main() {
    std::vector<int> arr = { 66, 47, 9, 96, 64, 36, 48, 31, 30, 74 };
    std::sort(arr.begin(),arr.end());
    int t=arr[arr.size()/2];
    std::cout<<"Sorted: "; for(int x:arr) std::cout<<x<<" "; std::cout<<"\n";
    std::cout<<"Search "<<t<<": index "<<search_571114qbmj::binary(arr,t)<<"\n";
    return 0;
}
