...
int main() {
    ds_490604tdwy::Stack<int> stk;
    for(int x:{ 80, 75, 28, 42, 50, 36, 12, 67, 89 }) stk.push(x);
    std::cout<<"Stack top: "<<stk.peek()<<" size: "<<stk.size()<<"\n";
    ds_490604tdwy::CQueue<int> q(20);
    for(int x:{ 80, 75, 28, 42, 50, 36, 12, 67, 89 }) q.enqueue(x);
