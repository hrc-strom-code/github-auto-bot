...
int main() {
    ds_872036wuai::Stack<int> stk;
    for(int x:{ 18, 68, 60, 19, 75, 68 }) stk.push(x);
    std::cout<<"Stack top: "<<stk.peek()<<" size: "<<stk.size()<<"\n";
    ds_872036wuai::CQueue<int> q(20);
    for(int x:{ 18, 68, 60, 19, 75, 68 }) q.enqueue(x);
