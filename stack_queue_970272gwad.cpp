// Auto-generated: 2026-05-11 11:59:30
// Topic: Stack and Circular Queue
#include <iostream>
#include <vector>
#include <stdexcept>

namespace ds_970272gwad {
...
int main() {
    ds_970272gwad::Stack<int> stk;
    for(int x:{ 7, 17, 1, 31, 39, 46, 43, 77 }) stk.push(x);
    std::cout<<"Stack top: "<<stk.peek()<<" size: "<<stk.size()<<"\n";
    ds_970272gwad::CQueue<int> q(20);
    for(int x:{ 7, 17, 1, 31, 39, 46, 43, 77 }) q.enqueue(x);
