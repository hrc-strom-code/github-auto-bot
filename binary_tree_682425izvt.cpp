// Auto-generated: 2026-05-10 10:38:02
// Topic: Binary Search Tree — Insert, Search, Traversal
#include <iostream>
#include <memory>
#include <queue>

namespace bst_682425izvt {
...
int main() {
    std::shared_ptr<bst_682425izvt::Node> root;
    for(int x:{ 32, 50, 92, 82, 79, 15 }) root=bst_682425izvt::insert(root,x);
    std::cout<<"Inorder:     "; bst_682425izvt::inorder(root); std::cout<<"\n";
    std::cout<<"Level order: "; bst_682425izvt::level_order(root); std::cout<<"\n";
    return 0;
}
