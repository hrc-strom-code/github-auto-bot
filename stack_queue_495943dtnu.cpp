...
int main() {
    ds_495943dtnu::Stack<int> stk;
    for(int x:{ 49, 54, 64, 11, 61, 49, 21 }) stk.push(x);
    std::cout<<"Stack top: "<<stk.peek()<<" size: "<<stk.size()<<"\n";
    ds_495943dtnu::CQueue<int> q(20);
    for(int x:{ 49, 54, 64, 11, 61, 49, 21 }) q.enqueue(x);
