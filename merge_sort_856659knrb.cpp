...
int main() {
    std::vector<int> arr = { 45, 82, 21, 86, 83, 59, 88, 88, 44 };
    std::cout<<"Before: "; merge_856659knrb::print(arr);
    merge_856659knrb::sort(arr,0,arr.size()-1);
    std::cout<<"After:  "; merge_856659knrb::print(arr);
    return 0;
}
