...
int main() {
    std::shared_ptr<bst_864603qwxn::Node> root;
    for(int x:{ 80, 56, 99, 19, 44, 15, 26, 96, 38, 9 }) root=bst_864603qwxn::insert(root,x);
    std::cout<<"Inorder:     "; bst_864603qwxn::inorder(root); std::cout<<"\n";
    std::cout<<"Level order: "; bst_864603qwxn::level_order(root); std::cout<<"\n";
    return 0;
}
