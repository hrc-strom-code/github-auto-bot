// Auto-generated: 2026-05-10 10:33:40
// Topic: Stack and Circular Queue
#include <iostream>
#include <vector>
#include <stdexcept>

namespace ds_420894nygd {
...
int main() {
    ds_420894nygd::Stack<int> stk;
    for(int x:{ 70, 23, 91, 81, 26, 63 }) stk.push(x);
    std::cout<<"Stack top: "<<stk.peek()<<" size: "<<stk.size()<<"\n";
    ds_420894nygd::CQueue<int> q(20);
    for(int x:{ 70, 23, 91, 81, 26, 63 }) q.enqueue(x);
