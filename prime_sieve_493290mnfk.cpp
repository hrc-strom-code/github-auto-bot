...
int main() {
    auto primes=primes_493290mnfk::sieve(44);
    std::cout<<"Primes up to 44: "; for(int p:primes) std::cout<<p<<" "; std::cout<<"\n";
    int n=15*7;
    std::cout<<"Factors of "<<n<<": ";
    for(int f:primes_493290mnfk::factorize(n)) std::cout<<f<<" "; std::cout<<"\n";
    return 0;
}
