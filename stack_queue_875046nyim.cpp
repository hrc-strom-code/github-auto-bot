...
int main() {
    ds_875046nyim::Stack<int> stk;
    for(int x:{ 16, 35, 99, 54, 75, 76, 39, 53, 74 }) stk.push(x);
    std::cout<<"Stack top: "<<stk.peek()<<" size: "<<stk.size()<<"\n";
    ds_875046nyim::CQueue<int> q(20);
    for(int x:{ 16, 35, 99, 54, 75, 76, 39, 53, 74 }) q.enqueue(x);
