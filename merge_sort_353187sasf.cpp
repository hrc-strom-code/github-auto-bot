// Auto-generated: 2026-05-10 10:32:33
// Topic: Merge Sort
#include <iostream>
#include <vector>

namespace merge_353187sasf {
...
int main() {
    std::vector<int> arr = { 95, 9, 43, 86, 73, 84, 80, 20 };
    std::cout<<"Before: "; merge_353187sasf::print(arr);
    merge_353187sasf::sort(arr,0,arr.size()-1);
    std::cout<<"After:  "; merge_353187sasf::print(arr);
    return 0;
}
