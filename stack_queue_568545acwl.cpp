// Auto-generated: 2026-05-10 10:36:08
// Topic: Stack and Circular Queue
#include <iostream>
#include <vector>
#include <stdexcept>

namespace ds_568545acwl {
...
int main() {
    ds_568545acwl::Stack<int> stk;
    for(int x:{ 63, 54, 36, 62, 19, 61, 17, 75, 96, 70 }) stk.push(x);
    std::cout<<"Stack top: "<<stk.peek()<<" size: "<<stk.size()<<"\n";
    ds_568545acwl::CQueue<int> q(20);
    for(int x:{ 63, 54, 36, 62, 19, 61, 17, 75, 96, 70 }) q.enqueue(x);
