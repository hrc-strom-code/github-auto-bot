// Auto-generated: 2026-05-11 11:59:27
// Topic: Sieve of Eratosthenes
#include <iostream>
#include <vector>
#include <cmath>

namespace primes_967402lupm {
...
int main() {
    auto primes=primes_967402lupm::sieve(51);
    std::cout<<"Primes up to 51: "; for(int p:primes) std::cout<<p<<" "; std::cout<<"\n";
    int n=8*7;
    std::cout<<"Factors of "<<n<<": ";
    for(int f:primes_967402lupm::factorize(n)) std::cout<<f<<" "; std::cout<<"\n";
    return 0;
}
