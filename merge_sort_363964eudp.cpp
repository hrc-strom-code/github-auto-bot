// Auto-generated: 2026-05-10 10:32:43
// Topic: Merge Sort
#include <iostream>
#include <vector>

namespace merge_363964eudp {
...
int main() {
    std::vector<int> arr = { 2, 9, 43, 83, 57, 42, 83, 35, 19 };
    std::cout<<"Before: "; merge_363964eudp::print(arr);
    merge_363964eudp::sort(arr,0,arr.size()-1);
    std::cout<<"After:  "; merge_363964eudp::print(arr);
    return 0;
}
