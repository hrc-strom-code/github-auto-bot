...
int main() {
    ds_855087yglg::Stack<int> stk;
    for(int x:{ 26, 1, 10, 12, 43, 52 }) stk.push(x);
    std::cout<<"Stack top: "<<stk.peek()<<" size: "<<stk.size()<<"\n";
    ds_855087yglg::CQueue<int> q(20);
    for(int x:{ 26, 1, 10, 12, 43, 52 }) q.enqueue(x);
