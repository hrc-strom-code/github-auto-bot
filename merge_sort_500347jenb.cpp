...
int main() {
    std::vector<int> arr = { 15, 96, 8, 61, 63, 34, 94, 63, 20, 40 };
    std::cout<<"Before: "; merge_500347jenb::print(arr);
    merge_500347jenb::sort(arr,0,arr.size()-1);
    std::cout<<"After:  "; merge_500347jenb::print(arr);
    return 0;
}
