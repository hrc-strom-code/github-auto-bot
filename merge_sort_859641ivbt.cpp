...
int main() {
    std::vector<int> arr = { 7, 37, 5, 27, 33, 28, 85, 1 };
    std::cout<<"Before: "; merge_859641ivbt::print(arr);
    merge_859641ivbt::sort(arr,0,arr.size()-1);
    std::cout<<"After:  "; merge_859641ivbt::print(arr);
    return 0;
}
