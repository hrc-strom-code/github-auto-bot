...
int main() {
    std::vector<int> arr = { 75, 44, 75, 95, 84, 59, 9, 74, 1 };
    std::cout<<"Before: "; merge_851283zvjv::print(arr);
    merge_851283zvjv::sort(arr,0,arr.size()-1);
    std::cout<<"After:  "; merge_851283zvjv::print(arr);
    return 0;
}
