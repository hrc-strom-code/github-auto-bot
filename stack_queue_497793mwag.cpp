// Auto-generated: 2026-05-10 10:34:57
// Topic: Stack and Circular Queue
#include <iostream>
#include <vector>
#include <stdexcept>

namespace ds_497793mwag {
...
int main() {
    ds_497793mwag::Stack<int> stk;
    for(int x:{ 70, 92, 14, 15, 86, 17, 4, 75 }) stk.push(x);
    std::cout<<"Stack top: "<<stk.peek()<<" size: "<<stk.size()<<"\n";
    ds_497793mwag::CQueue<int> q(20);
    for(int x:{ 70, 92, 14, 15, 86, 17, 4, 75 }) q.enqueue(x);
