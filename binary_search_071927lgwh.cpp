// Auto-generated: 2026-05-11 17:17:51
// Topic: Binary Search & Linear Search
#include <iostream>
#include <vector>
#include <algorithm>

namespace search_071927lgwh {
...
int main() {
    std::vector<int> arr = { 70, 74, 44, 28, 38, 52, 20, 8, 89, 89 };
    std::sort(arr.begin(),arr.end());
    int t=arr[arr.size()/2];
    std::cout<<"Sorted: "; for(int x:arr) std::cout<<x<<" "; std::cout<<"\n";
    std::cout<<"Search "<<t<<": index "<<search_071927lgwh::binary(arr,t)<<"\n";
    return 0;
}
