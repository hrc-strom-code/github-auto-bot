...
int main() {
    auto primes=primes_860718ypvx::sieve(42);
    std::cout<<"Primes up to 42: "; for(int p:primes) std::cout<<p<<" "; std::cout<<"\n";
    int n=12*7;
    std::cout<<"Factors of "<<n<<": ";
    for(int f:primes_860718ypvx::factorize(n)) std::cout<<f<<" "; std::cout<<"\n";
    return 0;
}
