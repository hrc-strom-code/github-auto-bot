// Auto-generated: 2026-05-10 10:37:52
// Topic: Merge Sort
#include <iostream>
#include <vector>

namespace merge_672182sziz {
...
int main() {
    std::vector<int> arr = { 6, 83, 41, 11, 60, 44 };
    std::cout<<"Before: "; merge_672182sziz::print(arr);
    merge_672182sziz::sort(arr,0,arr.size()-1);
    std::cout<<"After:  "; merge_672182sziz::print(arr);
    return 0;
}
