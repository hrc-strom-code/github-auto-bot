...
int main() {
    std::vector<int> arr = { 8, 73, 81, 4, 73, 6, 2, 33, 49 };
    std::cout<<"Before: "; merge_504808kewy::print(arr);
    merge_504808kewy::sort(arr,0,arr.size()-1);
    std::cout<<"After:  "; merge_504808kewy::print(arr);
    return 0;
}
