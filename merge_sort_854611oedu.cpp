...
int main() {
    std::vector<int> arr = { 97, 14, 3, 76, 64, 2 };
    std::cout<<"Before: "; merge_854611oedu::print(arr);
    merge_854611oedu::sort(arr,0,arr.size()-1);
    std::cout<<"After:  "; merge_854611oedu::print(arr);
    return 0;
}
