// Auto-generated: 2026-05-10 10:36:26
// Topic: Stack and Circular Queue
#include <iostream>
#include <vector>
#include <stdexcept>

namespace ds_586553xqyp {
...
int main() {
    ds_586553xqyp::Stack<int> stk;
    for(int x:{ 81, 6, 38, 90, 76, 70, 34, 24, 17, 63 }) stk.push(x);
    std::cout<<"Stack top: "<<stk.peek()<<" size: "<<stk.size()<<"\n";
    ds_586553xqyp::CQueue<int> q(20);
    for(int x:{ 81, 6, 38, 90, 76, 70, 34, 24, 17, 63 }) q.enqueue(x);
