// Auto-generated: 2026-05-11 17:08:20
// Topic: Binary Search Tree — Insert, Search, Traversal
#include <iostream>
#include <memory>
#include <queue>

namespace bst_500210imup {
...
int main() {
    std::shared_ptr<bst_500210imup::Node> root;
    for(int x:{ 13, 13, 74, 20, 77, 86, 9, 14, 97, 15 }) root=bst_500210imup::insert(root,x);
    std::cout<<"Inorder:     "; bst_500210imup::inorder(root); std::cout<<"\n";
    std::cout<<"Level order: "; bst_500210imup::level_order(root); std::cout<<"\n";
    return 0;
}
