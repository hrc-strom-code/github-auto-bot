...
int main() {
    std::vector<int> arr = { 30, 27, 48, 68, 87, 11, 26, 63, 91 };
    std::cout<<"Before: "; merge_495322yfgz::print(arr);
    merge_495322yfgz::sort(arr,0,arr.size()-1);
    std::cout<<"After:  "; merge_495322yfgz::print(arr);
    return 0;
}
