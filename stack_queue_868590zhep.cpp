...
int main() {
    ds_868590zhep::Stack<int> stk;
    for(int x:{ 22, 23, 80, 74, 95, 19, 86 }) stk.push(x);
    std::cout<<"Stack top: "<<stk.peek()<<" size: "<<stk.size()<<"\n";
    ds_868590zhep::CQueue<int> q(20);
    for(int x:{ 22, 23, 80, 74, 95, 19, 86 }) q.enqueue(x);
