// Auto-generated: 2026-05-10 10:33:46
// Topic: Binary Search Tree — Insert, Search, Traversal
#include <iostream>
#include <memory>
#include <queue>

namespace bst_426545tgae {
...
int main() {
    std::shared_ptr<bst_426545tgae::Node> root;
    for(int x:{ 59, 24, 2, 13, 42, 26, 53, 3, 91 }) root=bst_426545tgae::insert(root,x);
    std::cout<<"Inorder:     "; bst_426545tgae::inorder(root); std::cout<<"\n";
    std::cout<<"Level order: "; bst_426545tgae::level_order(root); std::cout<<"\n";
    return 0;
}
