...
int main() {
    std::shared_ptr<bst_583565kzmj::Node> root;
    for(int x:{ 21, 76, 21, 77, 92, 65, 38, 90 }) root=bst_583565kzmj::insert(root,x);
    std::cout<<"Inorder:     "; bst_583565kzmj::inorder(root); std::cout<<"\n";
    std::cout<<"Level order: "; bst_583565kzmj::level_order(root); std::cout<<"\n";
    return 0;
}
