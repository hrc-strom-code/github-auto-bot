...
int main() {
    ds_498170fysh::Stack<int> stk;
    for(int x:{ 80, 2, 88, 9, 17, 17 }) stk.push(x);
    std::cout<<"Stack top: "<<stk.peek()<<" size: "<<stk.size()<<"\n";
    ds_498170fysh::CQueue<int> q(20);
    for(int x:{ 80, 2, 88, 9, 17, 17 }) q.enqueue(x);
