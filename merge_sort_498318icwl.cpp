...
int main() {
    std::vector<int> arr = { 77, 12, 27, 5, 6, 68, 9, 15, 41, 12 };
    std::cout<<"Before: "; merge_498318icwl::print(arr);
    merge_498318icwl::sort(arr,0,arr.size()-1);
    std::cout<<"After:  "; merge_498318icwl::print(arr);
    return 0;
}
