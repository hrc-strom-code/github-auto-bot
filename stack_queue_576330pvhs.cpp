// Auto-generated: 2026-05-10 10:36:16
// Topic: Stack and Circular Queue
#include <iostream>
#include <vector>
#include <stdexcept>

namespace ds_576330pvhs {
...
int main() {
    ds_576330pvhs::Stack<int> stk;
    for(int x:{ 15, 20, 11, 52, 81, 96, 46, 59, 21, 49 }) stk.push(x);
    std::cout<<"Stack top: "<<stk.peek()<<" size: "<<stk.size()<<"\n";
    ds_576330pvhs::CQueue<int> q(20);
    for(int x:{ 15, 20, 11, 52, 81, 96, 46, 59, 21, 49 }) q.enqueue(x);
