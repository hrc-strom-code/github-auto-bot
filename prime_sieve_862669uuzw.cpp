...
int main() {
    auto primes=primes_862669uuzw::sieve(56);
    std::cout<<"Primes up to 56: "; for(int p:primes) std::cout<<p<<" "; std::cout<<"\n";
    int n=9*7;
    std::cout<<"Factors of "<<n<<": ";
    for(int f:primes_862669uuzw::factorize(n)) std::cout<<f<<" "; std::cout<<"\n";
    return 0;
}
