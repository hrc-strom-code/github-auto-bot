...
int main() {
    std::vector<int> arr = { 7, 91, 74, 76, 24, 54, 37, 51, 13 };
    std::cout<<"Before: "; merge_860445eolt::print(arr);
    merge_860445eolt::sort(arr,0,arr.size()-1);
    std::cout<<"After:  "; merge_860445eolt::print(arr);
    return 0;
}
