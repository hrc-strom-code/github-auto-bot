// Auto-generated: 2026-05-11 11:57:43
// Topic: Binary Search Tree — Insert, Search, Traversal
#include <iostream>
#include <memory>
#include <queue>

namespace bst_863032unrl {
...
int main() {
    std::shared_ptr<bst_863032unrl::Node> root;
    for(int x:{ 80, 17, 14, 34, 17, 82, 59, 16, 49, 50 }) root=bst_863032unrl::insert(root,x);
    std::cout<<"Inorder:     "; bst_863032unrl::inorder(root); std::cout<<"\n";
    std::cout<<"Level order: "; bst_863032unrl::level_order(root); std::cout<<"\n";
    return 0;
}
