// Auto-generated: 2026-05-10 10:35:58
// Topic: Merge Sort
#include <iostream>
#include <vector>

namespace merge_558548hlbc {
...
int main() {
    std::vector<int> arr = { 14, 36, 54, 46, 53, 61 };
    std::cout<<"Before: "; merge_558548hlbc::print(arr);
    merge_558548hlbc::sort(arr,0,arr.size()-1);
    std::cout<<"After:  "; merge_558548hlbc::print(arr);
    return 0;
}
