// Auto-generated: 2026-05-10 10:37:03
// Topic: Merge Sort
#include <iostream>
#include <vector>

namespace merge_623401sxjk {
...
int main() {
    std::vector<int> arr = { 54, 12, 19, 26, 24, 19, 85 };
    std::cout<<"Before: "; merge_623401sxjk::print(arr);
    merge_623401sxjk::sort(arr,0,arr.size()-1);
    std::cout<<"After:  "; merge_623401sxjk::print(arr);
    return 0;
}
