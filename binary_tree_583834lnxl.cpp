...
int main() {
    std::shared_ptr<bst_583834lnxl::Node> root;
    for(int x:{ 71, 1, 46, 7, 47, 29, 67 }) root=bst_583834lnxl::insert(root,x);
    std::cout<<"Inorder:     "; bst_583834lnxl::inorder(root); std::cout<<"\n";
    std::cout<<"Level order: "; bst_583834lnxl::level_order(root); std::cout<<"\n";
    return 0;
}
