...
int main() {
    ds_853545zcqb::Stack<int> stk;
    for(int x:{ 29, 88, 45, 51, 64, 76, 27 }) stk.push(x);
    std::cout<<"Stack top: "<<stk.peek()<<" size: "<<stk.size()<<"\n";
    ds_853545zcqb::CQueue<int> q(20);
    for(int x:{ 29, 88, 45, 51, 64, 76, 27 }) q.enqueue(x);
