...
int main() {
    std::shared_ptr<bst_869496fqpk::Node> root;
    for(int x:{ 95, 33, 86, 74, 53, 73, 55, 17 }) root=bst_869496fqpk::insert(root,x);
    std::cout<<"Inorder:     "; bst_869496fqpk::inorder(root); std::cout<<"\n";
    std::cout<<"Level order: "; bst_869496fqpk::level_order(root); std::cout<<"\n";
    return 0;
}
