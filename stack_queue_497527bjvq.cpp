...
int main() {
    ds_497527bjvq::Stack<int> stk;
    for(int x:{ 10, 23, 46, 97, 63, 24, 54 }) stk.push(x);
    std::cout<<"Stack top: "<<stk.peek()<<" size: "<<stk.size()<<"\n";
    ds_497527bjvq::CQueue<int> q(20);
    for(int x:{ 10, 23, 46, 97, 63, 24, 54 }) q.enqueue(x);
