// Auto-generated: 2026-05-11 17:08:22
// Topic: Merge Sort
#include <iostream>
#include <vector>

namespace merge_502285cddi {
...
int main() {
    std::vector<int> arr = { 57, 66, 68, 74, 21, 87, 68 };
    std::cout<<"Before: "; merge_502285cddi::print(arr);
    merge_502285cddi::sort(arr,0,arr.size()-1);
    std::cout<<"After:  "; merge_502285cddi::print(arr);
    return 0;
}
