// Auto-generated: 2026-05-10 10:37:31
// Topic: Singly Linked List with Reverse
#include <iostream>
#include <memory>

namespace linked_list_651701peey {
...
int main() {
    linked_list_651701peey::List<int> lst;
    for(int x:{ 34, 29, 62, 75, 87, 50, 70, 88, 16, 5 }) lst.push_back(x);
