...
int main() {
    ds_861675rwgu::Stack<int> stk;
    for(int x:{ 32, 12, 43, 71, 58, 26, 15, 92 }) stk.push(x);
    std::cout<<"Stack top: "<<stk.peek()<<" size: "<<stk.size()<<"\n";
    ds_861675rwgu::CQueue<int> q(20);
    for(int x:{ 32, 12, 43, 71, 58, 26, 15, 92 }) q.enqueue(x);
