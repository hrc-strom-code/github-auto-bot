// Auto-generated: 2026-05-10 10:35:48
// Topic: Binary Search Tree — Insert, Search, Traversal
#include <iostream>
#include <memory>
#include <queue>

namespace bst_548764ckpb {
...
int main() {
    std::shared_ptr<bst_548764ckpb::Node> root;
    for(int x:{ 28, 50, 27, 34, 65, 4, 2, 74, 38 }) root=bst_548764ckpb::insert(root,x);
    std::cout<<"Inorder:     "; bst_548764ckpb::inorder(root); std::cout<<"\n";
    std::cout<<"Level order: "; bst_548764ckpb::level_order(root); std::cout<<"\n";
    return 0;
}
