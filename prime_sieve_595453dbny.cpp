// Auto-generated: 2026-05-10 10:36:35
// Topic: Sieve of Eratosthenes
#include <iostream>
#include <vector>
#include <cmath>

namespace primes_595453dbny {
...
int main() {
    auto primes=primes_595453dbny::sieve(35);
    std::cout<<"Primes up to 35: "; for(int p:primes) std::cout<<p<<" "; std::cout<<"\n";
    int n=10*7;
    std::cout<<"Factors of "<<n<<": ";
    for(int f:primes_595453dbny::factorize(n)) std::cout<<f<<" "; std::cout<<"\n";
    return 0;
}
