...
int main() {
    ds_865625jihw::Stack<int> stk;
    for(int x:{ 21, 55, 84, 31, 49, 88, 25 }) stk.push(x);
    std::cout<<"Stack top: "<<stk.peek()<<" size: "<<stk.size()<<"\n";
    ds_865625jihw::CQueue<int> q(20);
    for(int x:{ 21, 55, 84, 31, 49, 88, 25 }) q.enqueue(x);
