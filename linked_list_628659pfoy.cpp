// Auto-generated: 2026-05-10 10:37:08
// Topic: Singly Linked List with Reverse
#include <iostream>
#include <memory>

namespace linked_list_628659pfoy {
...
int main() {
    linked_list_628659pfoy::List<int> lst;
    for(int x:{ 55, 45, 98, 78, 18, 86, 99, 19, 41 }) lst.push_back(x);
