// Auto-generated: 2026-05-10 10:37:26
// Topic: Binary Search & Linear Search
#include <iostream>
#include <vector>
#include <algorithm>

namespace search_646476yfrw {
...
int main() {
    std::vector<int> arr = { 54, 42, 74, 95, 74, 46, 78 };
    std::sort(arr.begin(),arr.end());
    int t=arr[arr.size()/2];
    std::cout<<"Sorted: "; for(int x:arr) std::cout<<x<<" "; std::cout<<"\n";
    std::cout<<"Search "<<t<<": index "<<search_646476yfrw::binary(arr,t)<<"\n";
    return 0;
}
