// Auto-generated: 2026-05-10 10:33:33
// Topic: Binary Search Tree — Insert, Search, Traversal
#include <iostream>
#include <memory>
#include <queue>

namespace bst_413008frhd {
...
int main() {
    std::shared_ptr<bst_413008frhd::Node> root;
    for(int x:{ 62, 74, 26, 62, 8, 20, 36 }) root=bst_413008frhd::insert(root,x);
    std::cout<<"Inorder:     "; bst_413008frhd::inorder(root); std::cout<<"\n";
    std::cout<<"Level order: "; bst_413008frhd::level_order(root); std::cout<<"\n";
    return 0;
}
