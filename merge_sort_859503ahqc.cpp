...
int main() {
    std::vector<int> arr = { 70, 57, 12, 10, 20, 22, 94, 61 };
    std::cout<<"Before: "; merge_859503ahqc::print(arr);
    merge_859503ahqc::sort(arr,0,arr.size()-1);
    std::cout<<"After:  "; merge_859503ahqc::print(arr);
    return 0;
}
