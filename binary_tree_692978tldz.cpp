// Auto-generated: 2026-05-10 10:38:12
// Topic: Binary Search Tree — Insert, Search, Traversal
#include <iostream>
#include <memory>
#include <queue>

namespace bst_692978tldz {
...
int main() {
    std::shared_ptr<bst_692978tldz::Node> root;
    for(int x:{ 60, 10, 72, 57, 7, 92, 56, 16, 17 }) root=bst_692978tldz::insert(root,x);
    std::cout<<"Inorder:     "; bst_692978tldz::inorder(root); std::cout<<"\n";
    std::cout<<"Level order: "; bst_692978tldz::level_order(root); std::cout<<"\n";
    return 0;
}
