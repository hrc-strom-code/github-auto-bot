// Auto-generated: 2026-05-10 10:35:44
// Topic: Sieve of Eratosthenes
#include <iostream>
#include <vector>
#include <cmath>

namespace primes_544273adun {
...
int main() {
    auto primes=primes_544273adun::sieve(32);
    std::cout<<"Primes up to 32: "; for(int p:primes) std::cout<<p<<" "; std::cout<<"\n";
    int n=15*7;
    std::cout<<"Factors of "<<n<<": ";
    for(int f:primes_544273adun::factorize(n)) std::cout<<f<<" "; std::cout<<"\n";
    return 0;
}
