...
int main() {
    std::vector<int> arr = { 39, 49, 5, 80, 3, 34, 73, 97, 27 };
    std::cout<<"Before: "; merge_851593eitx::print(arr);
    merge_851593eitx::sort(arr,0,arr.size()-1);
    std::cout<<"After:  "; merge_851593eitx::print(arr);
    return 0;
}
