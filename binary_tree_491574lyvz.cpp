...
int main() {
    std::shared_ptr<bst_491574lyvz::Node> root;
    for(int x:{ 19, 45, 16, 32, 34, 76, 63 }) root=bst_491574lyvz::insert(root,x);
    std::cout<<"Inorder:     "; bst_491574lyvz::inorder(root); std::cout<<"\n";
    std::cout<<"Level order: "; bst_491574lyvz::level_order(root); std::cout<<"\n";
    return 0;
}
