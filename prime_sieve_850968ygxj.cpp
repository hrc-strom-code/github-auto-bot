// Auto-generated: 2026-05-11 11:57:30
// Topic: Sieve of Eratosthenes
#include <iostream>
#include <vector>
#include <cmath>

namespace primes_850968ygxj {
...
int main() {
    auto primes=primes_850968ygxj::sieve(48);
    std::cout<<"Primes up to 48: "; for(int p:primes) std::cout<<p<<" "; std::cout<<"\n";
    int n=8*7;
    std::cout<<"Factors of "<<n<<": ";
    for(int f:primes_850968ygxj::factorize(n)) std::cout<<f<<" "; std::cout<<"\n";
    return 0;
}
