// Auto-generated: 2026-05-10 10:35:03
// Topic: Sieve of Eratosthenes
#include <iostream>
#include <vector>
#include <cmath>

namespace primes_503221vxpq {
...
int main() {
    auto primes=primes_503221vxpq::sieve(37);
    std::cout<<"Primes up to 37: "; for(int p:primes) std::cout<<p<<" "; std::cout<<"\n";
    int n=12*7;
    std::cout<<"Factors of "<<n<<": ";
    for(int f:primes_503221vxpq::factorize(n)) std::cout<<f<<" "; std::cout<<"\n";
    return 0;
}
