...
int main() {
    std::shared_ptr<bst_852495bcmg::Node> root;
    for(int x:{ 26, 17, 80, 97, 17, 83, 17, 62 }) root=bst_852495bcmg::insert(root,x);
    std::cout<<"Inorder:     "; bst_852495bcmg::inorder(root); std::cout<<"\n";
    std::cout<<"Level order: "; bst_852495bcmg::level_order(root); std::cout<<"\n";
    return 0;
}
