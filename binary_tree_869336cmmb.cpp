// Auto-generated: 2026-05-11 11:57:49
// Topic: Binary Search Tree — Insert, Search, Traversal
#include <iostream>
#include <memory>
#include <queue>

namespace bst_869336cmmb {
...
int main() {
    std::shared_ptr<bst_869336cmmb::Node> root;
    for(int x:{ 22, 15, 81, 36, 50, 89, 45, 12, 41, 88 }) root=bst_869336cmmb::insert(root,x);
    std::cout<<"Inorder:     "; bst_869336cmmb::inorder(root); std::cout<<"\n";
    std::cout<<"Level order: "; bst_869336cmmb::level_order(root); std::cout<<"\n";
    return 0;
}
