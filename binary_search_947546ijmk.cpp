// Auto-generated: 2026-05-11 11:59:07
// Topic: Binary Search & Linear Search
#include <iostream>
#include <vector>
#include <algorithm>

namespace search_947546ijmk {
...
int main() {
    std::vector<int> arr = { 85, 38, 87, 9, 97, 1, 52, 89 };
    std::sort(arr.begin(),arr.end());
    int t=arr[arr.size()/2];
    std::cout<<"Sorted: "; for(int x:arr) std::cout<<x<<" "; std::cout<<"\n";
    std::cout<<"Search "<<t<<": index "<<search_947546ijmk::binary(arr,t)<<"\n";
    return 0;
}
