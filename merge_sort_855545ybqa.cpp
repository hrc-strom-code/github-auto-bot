// Auto-generated: 2026-05-11 11:57:35
// Topic: Merge Sort
#include <iostream>
#include <vector>

namespace merge_855545ybqa {
...
int main() {
    std::vector<int> arr = { 69, 46, 69, 2, 91, 23, 73 };
    std::cout<<"Before: "; merge_855545ybqa::print(arr);
    merge_855545ybqa::sort(arr,0,arr.size()-1);
    std::cout<<"After:  "; merge_855545ybqa::print(arr);
    return 0;
}
