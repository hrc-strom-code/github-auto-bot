// Auto-generated: 2026-05-10 10:33:38
// Topic: Singly Linked List with Reverse
#include <iostream>
#include <memory>

namespace linked_list_418027arok {
...
int main() {
    linked_list_418027arok::List<int> lst;
    for(int x:{ 13, 13, 84, 50, 87, 35, 25, 3, 65, 24 }) lst.push_back(x);
