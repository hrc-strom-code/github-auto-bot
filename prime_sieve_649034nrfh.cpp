// Auto-generated: 2026-05-10 10:37:29
// Topic: Sieve of Eratosthenes
#include <iostream>
#include <vector>
#include <cmath>

namespace primes_649034nrfh {
...
int main() {
    auto primes=primes_649034nrfh::sieve(57);
    std::cout<<"Primes up to 57: "; for(int p:primes) std::cout<<p<<" "; std::cout<<"\n";
    int n=11*7;
    std::cout<<"Factors of "<<n<<": ";
    for(int f:primes_649034nrfh::factorize(n)) std::cout<<f<<" "; std::cout<<"\n";
    return 0;
}
