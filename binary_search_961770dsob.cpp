// Auto-generated: 2026-05-11 11:59:21
// Topic: Binary Search & Linear Search
#include <iostream>
#include <vector>
#include <algorithm>

namespace search_961770dsob {
...
int main() {
    std::vector<int> arr = { 87, 82, 44, 58, 60, 18, 81, 60 };
    std::sort(arr.begin(),arr.end());
    int t=arr[arr.size()/2];
    std::cout<<"Sorted: "; for(int x:arr) std::cout<<x<<" "; std::cout<<"\n";
    std::cout<<"Search "<<t<<": index "<<search_961770dsob::binary(arr,t)<<"\n";
    return 0;
}
