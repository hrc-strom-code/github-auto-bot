// Auto-generated: 2026-05-10 10:33:15
// Topic: Binary Search & Linear Search
#include <iostream>
#include <vector>
#include <algorithm>

namespace search_395003rstu {
...
int main() {
    std::vector<int> arr = { 57, 8, 29, 4, 41, 8, 97, 66, 93, 39 };
    std::sort(arr.begin(),arr.end());
    int t=arr[arr.size()/2];
    std::cout<<"Sorted: "; for(int x:arr) std::cout<<x<<" "; std::cout<<"\n";
    std::cout<<"Search "<<t<<": index "<<search_395003rstu::binary(arr,t)<<"\n";
    return 0;
}
