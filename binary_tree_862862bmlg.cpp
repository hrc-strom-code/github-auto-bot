...
int main() {
    std::shared_ptr<bst_862862bmlg::Node> root;
    for(int x:{ 16, 89, 65, 93, 63, 11, 27 }) root=bst_862862bmlg::insert(root,x);
    std::cout<<"Inorder:     "; bst_862862bmlg::inorder(root); std::cout<<"\n";
    std::cout<<"Level order: "; bst_862862bmlg::level_order(root); std::cout<<"\n";
    return 0;
}
