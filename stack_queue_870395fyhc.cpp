...
int main() {
    ds_870395fyhc::Stack<int> stk;
    for(int x:{ 60, 20, 47, 82, 77, 18, 66 }) stk.push(x);
    std::cout<<"Stack top: "<<stk.peek()<<" size: "<<stk.size()<<"\n";
    ds_870395fyhc::CQueue<int> q(20);
    for(int x:{ 60, 20, 47, 82, 77, 18, 66 }) q.enqueue(x);
