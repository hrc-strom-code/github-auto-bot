...
int main() {
    std::shared_ptr<bst_499722lapn::Node> root;
    for(int x:{ 88, 5, 86, 37, 49, 11, 71 }) root=bst_499722lapn::insert(root,x);
    std::cout<<"Inorder:     "; bst_499722lapn::inorder(root); std::cout<<"\n";
    std::cout<<"Level order: "; bst_499722lapn::level_order(root); std::cout<<"\n";
    return 0;
}
