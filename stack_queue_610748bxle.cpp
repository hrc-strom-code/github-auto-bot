// Auto-generated: 2026-05-10 10:36:50
// Topic: Stack and Circular Queue
#include <iostream>
#include <vector>
#include <stdexcept>

namespace ds_610748bxle {
...
int main() {
    ds_610748bxle::Stack<int> stk;
    for(int x:{ 79, 17, 92, 8, 44, 19 }) stk.push(x);
    std::cout<<"Stack top: "<<stk.peek()<<" size: "<<stk.size()<<"\n";
    ds_610748bxle::CQueue<int> q(20);
    for(int x:{ 79, 17, 92, 8, 44, 19 }) q.enqueue(x);
