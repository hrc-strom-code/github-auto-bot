// Auto-generated: 2026-05-11 11:58:00
// Topic: Binary Search Tree — Insert, Search, Traversal
#include <iostream>
#include <memory>
#include <queue>

namespace bst_880208iwkw {
...
int main() {
    std::shared_ptr<bst_880208iwkw::Node> root;
    for(int x:{ 3, 48, 74, 64, 68, 96, 93, 29, 75 }) root=bst_880208iwkw::insert(root,x);
    std::cout<<"Inorder:     "; bst_880208iwkw::inorder(root); std::cout<<"\n";
    std::cout<<"Level order: "; bst_880208iwkw::level_order(root); std::cout<<"\n";
    return 0;
}
