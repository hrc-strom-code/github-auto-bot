...
int main() {
    std::vector<int> arr = { 13, 46, 93, 44, 50, 76 };
    std::cout<<"Before: "; merge_873992kaua::print(arr);
    merge_873992kaua::sort(arr,0,arr.size()-1);
    std::cout<<"After:  "; merge_873992kaua::print(arr);
    return 0;
}
