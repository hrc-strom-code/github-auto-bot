// Auto-generated: 2026-05-10 10:34:49
// Topic: Merge Sort
#include <iostream>
#include <vector>

namespace merge_489517mdsq {
...
int main() {
    std::vector<int> arr = { 15, 77, 12, 62, 86, 21, 94, 3 };
    std::cout<<"Before: "; merge_489517mdsq::print(arr);
    merge_489517mdsq::sort(arr,0,arr.size()-1);
    std::cout<<"After:  "; merge_489517mdsq::print(arr);
    return 0;
}
