// Auto-generated: 2026-05-10 10:34:20
// Topic: Sieve of Eratosthenes
#include <iostream>
#include <vector>
#include <cmath>

namespace primes_460521wmxl {
...
int main() {
    auto primes=primes_460521wmxl::sieve(50);
    std::cout<<"Primes up to 50: "; for(int p:primes) std::cout<<p<<" "; std::cout<<"\n";
    int n=9*7;
    std::cout<<"Factors of "<<n<<": ";
    for(int f:primes_460521wmxl::factorize(n)) std::cout<<f<<" "; std::cout<<"\n";
    return 0;
}
