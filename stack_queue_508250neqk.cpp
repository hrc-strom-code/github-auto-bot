// Auto-generated: 2026-05-10 10:35:08
// Topic: Stack and Circular Queue
#include <iostream>
#include <vector>
#include <stdexcept>

namespace ds_508250neqk {
...
int main() {
    ds_508250neqk::Stack<int> stk;
    for(int x:{ 91, 59, 93, 42, 42, 76 }) stk.push(x);
    std::cout<<"Stack top: "<<stk.peek()<<" size: "<<stk.size()<<"\n";
    ds_508250neqk::CQueue<int> q(20);
    for(int x:{ 91, 59, 93, 42, 42, 76 }) q.enqueue(x);
