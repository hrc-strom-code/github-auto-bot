...
int main() {
    std::vector<int> arr = { 32, 5, 13, 54, 38, 42, 72, 89, 14 };
    std::cout<<"Before: "; merge_584619nfgb::print(arr);
    merge_584619nfgb::sort(arr,0,arr.size()-1);
    std::cout<<"After:  "; merge_584619nfgb::print(arr);
    return 0;
}
