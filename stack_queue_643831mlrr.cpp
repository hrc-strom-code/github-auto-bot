// Auto-generated: 2026-05-10 10:37:23
// Topic: Stack and Circular Queue
#include <iostream>
#include <vector>
#include <stdexcept>

namespace ds_643831mlrr {
...
int main() {
    ds_643831mlrr::Stack<int> stk;
    for(int x:{ 76, 95, 59, 79, 78, 81, 37, 21, 45 }) stk.push(x);
    std::cout<<"Stack top: "<<stk.peek()<<" size: "<<stk.size()<<"\n";
    ds_643831mlrr::CQueue<int> q(20);
    for(int x:{ 76, 95, 59, 79, 78, 81, 37, 21, 45 }) q.enqueue(x);
