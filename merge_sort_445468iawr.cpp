// Auto-generated: 2026-05-10 10:34:05
// Topic: Merge Sort
#include <iostream>
#include <vector>

namespace merge_445468iawr {
...
int main() {
    std::vector<int> arr = { 95, 89, 64, 83, 29, 70, 9, 18 };
    std::cout<<"Before: "; merge_445468iawr::print(arr);
    merge_445468iawr::sort(arr,0,arr.size()-1);
    std::cout<<"After:  "; merge_445468iawr::print(arr);
    return 0;
}
