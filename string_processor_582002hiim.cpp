...
int main() {
    ...
    std::cout<<"Original:  "<<s<<"\n";
    std::cout<<"Upper:     "<<str_582002hiim::upper(s)<<"\n";
    std::cout<<"Reversed:  "<<str_582002hiim::reverse_words(s)<<"\n";
    std::cout<<"Palindrome check 'racecar': "<<(str_582002hiim::palindrome("racecar")?"yes":"no")<<"\n";
    return 0;
}
