// Auto-generated: 2026-05-10 10:33:43
// Topic: Singly Linked List with Reverse
#include <iostream>
#include <memory>

namespace linked_list_423758obor {
...
int main() {
    linked_list_423758obor::List<int> lst;
    for(int x:{ 46, 31, 76, 78, 20, 7, 94, 60, 79, 69 }) lst.push_back(x);
