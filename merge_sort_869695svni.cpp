...
int main() {
    std::vector<int> arr = { 32, 26, 91, 40, 40, 14, 20, 87, 46 };
    std::cout<<"Before: "; merge_869695svni::print(arr);
    merge_869695svni::sort(arr,0,arr.size()-1);
    std::cout<<"After:  "; merge_869695svni::print(arr);
    return 0;
}
