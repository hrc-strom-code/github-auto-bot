// Auto-generated: 2026-05-10 10:35:24
// Topic: Binary Search & Linear Search
#include <iostream>
#include <vector>
#include <algorithm>

namespace search_524135dysg {
...
int main() {
    std::vector<int> arr = { 49, 34, 31, 40, 25, 43 };
    std::sort(arr.begin(),arr.end());
    int t=arr[arr.size()/2];
    std::cout<<"Sorted: "; for(int x:arr) std::cout<<x<<" "; std::cout<<"\n";
    std::cout<<"Search "<<t<<": index "<<search_524135dysg::binary(arr,t)<<"\n";
    return 0;
}
