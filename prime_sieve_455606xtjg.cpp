// Auto-generated: 2026-05-10 10:34:15
// Topic: Sieve of Eratosthenes
#include <iostream>
#include <vector>
#include <cmath>

namespace primes_455606xtjg {
...
int main() {
    auto primes=primes_455606xtjg::sieve(49);
    std::cout<<"Primes up to 49: "; for(int p:primes) std::cout<<p<<" "; std::cout<<"\n";
    int n=9*7;
    std::cout<<"Factors of "<<n<<": ";
    for(int f:primes_455606xtjg::factorize(n)) std::cout<<f<<" "; std::cout<<"\n";
    return 0;
}
