// Auto-generated: 2026-05-10 10:34:30
// Topic: Stack and Circular Queue
#include <iostream>
#include <vector>
#include <stdexcept>

namespace ds_470760yjvk {
...
int main() {
    ds_470760yjvk::Stack<int> stk;
    for(int x:{ 44, 37, 55, 42, 99, 60, 37, 80, 52 }) stk.push(x);
    std::cout<<"Stack top: "<<stk.peek()<<" size: "<<stk.size()<<"\n";
    ds_470760yjvk::CQueue<int> q(20);
    for(int x:{ 44, 37, 55, 42, 99, 60, 37, 80, 52 }) q.enqueue(x);
