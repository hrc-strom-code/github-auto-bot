// Auto-generated: 2026-05-11 17:08:18
// Topic: Binary Search Tree — Insert, Search, Traversal
#include <iostream>
#include <memory>
#include <queue>

namespace bst_498807tmrl {
...
int main() {
    std::shared_ptr<bst_498807tmrl::Node> root;
    for(int x:{ 85, 51, 93, 57, 81, 30, 71, 37, 15, 21 }) root=bst_498807tmrl::insert(root,x);
    std::cout<<"Inorder:     "; bst_498807tmrl::inorder(root); std::cout<<"\n";
    std::cout<<"Level order: "; bst_498807tmrl::level_order(root); std::cout<<"\n";
    return 0;
}
