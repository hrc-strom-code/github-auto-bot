...
int main() {
    ds_499865itti::Stack<int> stk;
    for(int x:{ 85, 15, 36, 46, 73, 47, 22 }) stk.push(x);
    std::cout<<"Stack top: "<<stk.peek()<<" size: "<<stk.size()<<"\n";
    ds_499865itti::CQueue<int> q(20);
    for(int x:{ 85, 15, 36, 46, 73, 47, 22 }) q.enqueue(x);
