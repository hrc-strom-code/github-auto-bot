// Auto-generated: 2026-05-10 10:32:22
// Topic: Singly Linked List with Reverse
#include <iostream>
#include <memory>

namespace linked_list_342146pbir {
...
int main() {
    linked_list_342146pbir::List<int> lst;
    for(int x:{ 89, 3, 77, 21, 50, 49, 67, 37, 67, 5 }) lst.push_back(x);
