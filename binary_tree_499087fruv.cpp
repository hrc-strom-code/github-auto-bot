...
int main() {
    std::shared_ptr<bst_499087fruv::Node> root;
    for(int x:{ 44, 37, 40, 99, 40, 40, 40, 14, 63 }) root=bst_499087fruv::insert(root,x);
    std::cout<<"Inorder:     "; bst_499087fruv::inorder(root); std::cout<<"\n";
    std::cout<<"Level order: "; bst_499087fruv::level_order(root); std::cout<<"\n";
    return 0;
}
