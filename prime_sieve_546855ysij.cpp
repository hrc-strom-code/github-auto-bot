// Auto-generated: 2026-05-10 10:19:06
// Topic: Sieve of Eratosthenes
#include <iostream>
#include <vector>
#include <cmath>

namespace primes_546855ysij {
...
int main() {
    auto primes=primes_546855ysij::sieve(54);
    std::cout<<"Primes up to 54: "; for(int p:primes) std::cout<<p<<" "; std::cout<<"\n";
    int n=13*7;
    std::cout<<"Factors of "<<n<<": ";
    for(int f:primes_546855ysij::factorize(n)) std::cout<<f<<" "; std::cout<<"\n";
    return 0;
}
