// Auto-generated: 2026-05-10 10:33:54
// Topic: Singly Linked List with Reverse
#include <iostream>
#include <memory>

namespace linked_list_434919ebko {
...
int main() {
    linked_list_434919ebko::List<int> lst;
    for(int x:{ 7, 39, 93, 90, 48, 66, 45, 2, 39 }) lst.push_back(x);
