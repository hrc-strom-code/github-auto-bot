// Auto-generated: 2026-05-11 17:08:19
// Topic: Binary Search Tree — Insert, Search, Traversal
#include <iostream>
#include <memory>
#include <queue>

namespace bst_499222wqal {
...
int main() {
    std::shared_ptr<bst_499222wqal::Node> root;
    for(int x:{ 84, 36, 98, 73, 12, 63, 68, 30, 45, 69 }) root=bst_499222wqal::insert(root,x);
    std::cout<<"Inorder:     "; bst_499222wqal::inorder(root); std::cout<<"\n";
    std::cout<<"Level order: "; bst_499222wqal::level_order(root); std::cout<<"\n";
    return 0;
}
