// Auto-generated: 2026-05-11 17:18:03
// Topic: Sieve of Eratosthenes
#include <iostream>
#include <vector>
#include <cmath>

namespace primes_083000txni {
...
int main() {
    auto primes=primes_083000txni::sieve(59);
    std::cout<<"Primes up to 59: "; for(int p:primes) std::cout<<p<<" "; std::cout<<"\n";
    int n=15*7;
    std::cout<<"Factors of "<<n<<": ";
    for(int f:primes_083000txni::factorize(n)) std::cout<<f<<" "; std::cout<<"\n";
    return 0;
}
