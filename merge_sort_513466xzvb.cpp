// Auto-generated: 2026-05-10 10:35:13
// Topic: Merge Sort
#include <iostream>
#include <vector>

namespace merge_513466xzvb {
...
int main() {
    std::vector<int> arr = { 65, 97, 11, 42, 70, 92 };
    std::cout<<"Before: "; merge_513466xzvb::print(arr);
    merge_513466xzvb::sort(arr,0,arr.size()-1);
    std::cout<<"After:  "; merge_513466xzvb::print(arr);
    return 0;
}
