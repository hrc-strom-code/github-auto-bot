// Auto-generated: 2026-05-10 10:32:48
// Topic: Sieve of Eratosthenes
#include <iostream>
#include <vector>
#include <cmath>

namespace primes_368770xyqw {
...
int main() {
    auto primes=primes_368770xyqw::sieve(34);
    std::cout<<"Primes up to 34: "; for(int p:primes) std::cout<<p<<" "; std::cout<<"\n";
    int n=9*7;
    std::cout<<"Factors of "<<n<<": ";
    for(int f:primes_368770xyqw::factorize(n)) std::cout<<f<<" "; std::cout<<"\n";
    return 0;
}
