// Auto-generated: 2026-05-11 17:08:14
// Topic: Binary Search Tree — Insert, Search, Traversal
#include <iostream>
#include <memory>
#include <queue>

namespace bst_494219sttr {
...
int main() {
    std::shared_ptr<bst_494219sttr::Node> root;
    for(int x:{ 53, 13, 15, 91, 17, 84, 47 }) root=bst_494219sttr::insert(root,x);
    std::cout<<"Inorder:     "; bst_494219sttr::inorder(root); std::cout<<"\n";
    std::cout<<"Level order: "; bst_494219sttr::level_order(root); std::cout<<"\n";
    return 0;
}
