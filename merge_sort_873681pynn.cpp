...
int main() {
    std::vector<int> arr = { 95, 61, 76, 87, 84, 8, 81, 48, 71 };
    std::cout<<"Before: "; merge_873681pynn::print(arr);
    merge_873681pynn::sort(arr,0,arr.size()-1);
    std::cout<<"After:  "; merge_873681pynn::print(arr);
    return 0;
}
