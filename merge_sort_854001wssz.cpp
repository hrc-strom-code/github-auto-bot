...
int main() {
    std::vector<int> arr = { 30, 8, 34, 51, 24, 27, 58, 27 };
    std::cout<<"Before: "; merge_854001wssz::print(arr);
    merge_854001wssz::sort(arr,0,arr.size()-1);
    std::cout<<"After:  "; merge_854001wssz::print(arr);
    return 0;
}
