// Auto-generated: 2026-05-11 11:57:41
// Topic: Binary Search Tree — Insert, Search, Traversal
#include <iostream>
#include <memory>
#include <queue>

namespace bst_861859inbn {
...
int main() {
    std::shared_ptr<bst_861859inbn::Node> root;
    for(int x:{ 56, 57, 14, 69, 91, 14 }) root=bst_861859inbn::insert(root,x);
    std::cout<<"Inorder:     "; bst_861859inbn::inorder(root); std::cout<<"\n";
    std::cout<<"Level order: "; bst_861859inbn::level_order(root); std::cout<<"\n";
    return 0;
}
