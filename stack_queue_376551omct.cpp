// Auto-generated: 2026-05-10 10:32:56
// Topic: Stack and Circular Queue
#include <iostream>
#include <vector>
#include <stdexcept>

namespace ds_376551omct {
...
int main() {
    ds_376551omct::Stack<int> stk;
    for(int x:{ 16, 30, 81, 9, 31, 28, 46, 40 }) stk.push(x);
    std::cout<<"Stack top: "<<stk.peek()<<" size: "<<stk.size()<<"\n";
    ds_376551omct::CQueue<int> q(20);
    for(int x:{ 16, 30, 81, 9, 31, 28, 46, 40 }) q.enqueue(x);
