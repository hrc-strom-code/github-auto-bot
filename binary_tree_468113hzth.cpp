// Auto-generated: 2026-05-10 10:34:28
// Topic: Binary Search Tree — Insert, Search, Traversal
#include <iostream>
#include <memory>
#include <queue>

namespace bst_468113hzth {
...
int main() {
    std::shared_ptr<bst_468113hzth::Node> root;
    for(int x:{ 4, 45, 9, 64, 96, 2, 22 }) root=bst_468113hzth::insert(root,x);
    std::cout<<"Inorder:     "; bst_468113hzth::inorder(root); std::cout<<"\n";
    std::cout<<"Level order: "; bst_468113hzth::level_order(root); std::cout<<"\n";
    return 0;
}
