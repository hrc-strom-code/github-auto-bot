// Auto-generated: 2026-05-11 11:57:31
// Topic: Binary Search Tree — Insert, Search, Traversal
#include <iostream>
#include <memory>
#include <queue>

namespace bst_851857lamy {
...
int main() {
    std::shared_ptr<bst_851857lamy::Node> root;
    for(int x:{ 19, 43, 41, 42, 77, 70 }) root=bst_851857lamy::insert(root,x);
    std::cout<<"Inorder:     "; bst_851857lamy::inorder(root); std::cout<<"\n";
    std::cout<<"Level order: "; bst_851857lamy::level_order(root); std::cout<<"\n";
    return 0;
}
