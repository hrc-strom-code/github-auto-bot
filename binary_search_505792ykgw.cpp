// Auto-generated: 2026-05-10 10:35:05
// Topic: Binary Search & Linear Search
#include <iostream>
#include <vector>
#include <algorithm>

namespace search_505792ykgw {
...
int main() {
    std::vector<int> arr = { 32, 24, 3, 13, 81, 34, 4 };
    std::sort(arr.begin(),arr.end());
    int t=arr[arr.size()/2];
    std::cout<<"Sorted: "; for(int x:arr) std::cout<<x<<" "; std::cout<<"\n";
    std::cout<<"Search "<<t<<": index "<<search_505792ykgw::binary(arr,t)<<"\n";
    return 0;
}
