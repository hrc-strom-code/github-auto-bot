...
int main() {
    ds_581547bhls::Stack<int> stk;
    for(int x:{ 22, 79, 48, 26, 63, 62, 91, 60 }) stk.push(x);
    std::cout<<"Stack top: "<<stk.peek()<<" size: "<<stk.size()<<"\n";
    ds_581547bhls::CQueue<int> q(20);
    for(int x:{ 22, 79, 48, 26, 63, 62, 91, 60 }) q.enqueue(x);
