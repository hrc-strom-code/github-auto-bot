// Auto-generated: 2026-05-10 10:34:25
// Topic: Singly Linked List with Reverse
#include <iostream>
#include <memory>

namespace linked_list_465540bbjg {
...
int main() {
    linked_list_465540bbjg::List<int> lst;
    for(int x:{ 76, 43, 90, 95, 34, 74, 90, 81, 61, 75 }) lst.push_back(x);
