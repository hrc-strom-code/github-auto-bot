// Auto-generated: 2026-05-11 11:57:42
// Topic: Binary Search Tree — Insert, Search, Traversal
#include <iostream>
#include <memory>
#include <queue>

namespace bst_862020ezkh {
...
int main() {
    std::shared_ptr<bst_862020ezkh::Node> root;
    for(int x:{ 62, 81, 77, 96, 53, 67, 64 }) root=bst_862020ezkh::insert(root,x);
    std::cout<<"Inorder:     "; bst_862020ezkh::inorder(root); std::cout<<"\n";
    std::cout<<"Level order: "; bst_862020ezkh::level_order(root); std::cout<<"\n";
    return 0;
}
