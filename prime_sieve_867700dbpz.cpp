...
int main() {
    auto primes=primes_867700dbpz::sieve(36);
    std::cout<<"Primes up to 36: "; for(int p:primes) std::cout<<p<<" "; std::cout<<"\n";
    int n=9*7;
    std::cout<<"Factors of "<<n<<": ";
    for(int f:primes_867700dbpz::factorize(n)) std::cout<<f<<" "; std::cout<<"\n";
    return 0;
}
