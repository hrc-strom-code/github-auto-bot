// Auto-generated: 2026-05-10 10:37:46
// Topic: Binary Search & Linear Search
#include <iostream>
#include <vector>
#include <algorithm>

namespace search_666850jcnq {
...
int main() {
    std::vector<int> arr = { 37, 29, 37, 21, 51, 93, 89, 95, 38, 64 };
    std::sort(arr.begin(),arr.end());
    int t=arr[arr.size()/2];
    std::cout<<"Sorted: "; for(int x:arr) std::cout<<x<<" "; std::cout<<"\n";
    std::cout<<"Search "<<t<<": index "<<search_666850jcnq::binary(arr,t)<<"\n";
    return 0;
}
