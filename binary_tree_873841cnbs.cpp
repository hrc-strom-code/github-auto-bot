...
int main() {
    std::shared_ptr<bst_873841cnbs::Node> root;
    for(int x:{ 25, 14, 46, 22, 58, 4, 88, 8 }) root=bst_873841cnbs::insert(root,x);
    std::cout<<"Inorder:     "; bst_873841cnbs::inorder(root); std::cout<<"\n";
    std::cout<<"Level order: "; bst_873841cnbs::level_order(root); std::cout<<"\n";
    return 0;
}
