// Auto-generated: 2026-05-11 11:57:55
// Topic: Binary Search Tree — Insert, Search, Traversal
#include <iostream>
#include <memory>
#include <queue>

namespace bst_875576gioy {
...
int main() {
    std::shared_ptr<bst_875576gioy::Node> root;
    for(int x:{ 92, 70, 72, 24, 9, 57, 76, 36 }) root=bst_875576gioy::insert(root,x);
    std::cout<<"Inorder:     "; bst_875576gioy::inorder(root); std::cout<<"\n";
    std::cout<<"Level order: "; bst_875576gioy::level_order(root); std::cout<<"\n";
    return 0;
}
