...
int main() {
    std::shared_ptr<bst_868918ajud::Node> root;
    for(int x:{ 34, 52, 11, 96, 29, 67, 2, 10 }) root=bst_868918ajud::insert(root,x);
    std::cout<<"Inorder:     "; bst_868918ajud::inorder(root); std::cout<<"\n";
    std::cout<<"Level order: "; bst_868918ajud::level_order(root); std::cout<<"\n";
    return 0;
}
