...
int main() {
    std::vector<int> arr = { 76, 73, 68, 73, 74, 64, 98, 42, 57 };
    std::cout<<"Before: "; merge_853410wuwf::print(arr);
    merge_853410wuwf::sort(arr,0,arr.size()-1);
    std::cout<<"After:  "; merge_853410wuwf::print(arr);
    return 0;
}
