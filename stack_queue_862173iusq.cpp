...
int main() {
    ds_862173iusq::Stack<int> stk;
    for(int x:{ 21, 61, 90, 95, 99, 83, 19 }) stk.push(x);
    std::cout<<"Stack top: "<<stk.peek()<<" size: "<<stk.size()<<"\n";
    ds_862173iusq::CQueue<int> q(20);
    for(int x:{ 21, 61, 90, 95, 99, 83, 19 }) q.enqueue(x);
