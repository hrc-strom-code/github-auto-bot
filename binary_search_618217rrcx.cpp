// Auto-generated: 2026-05-10 10:36:58
// Topic: Binary Search & Linear Search
#include <iostream>
#include <vector>
#include <algorithm>

namespace search_618217rrcx {
...
int main() {
    std::vector<int> arr = { 98, 10, 72, 94, 16, 32, 35, 45, 60, 66 };
    std::sort(arr.begin(),arr.end());
    int t=arr[arr.size()/2];
    std::cout<<"Sorted: "; for(int x:arr) std::cout<<x<<" "; std::cout<<"\n";
    std::cout<<"Search "<<t<<": index "<<search_618217rrcx::binary(arr,t)<<"\n";
    return 0;
}
