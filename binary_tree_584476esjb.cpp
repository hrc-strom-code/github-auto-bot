...
int main() {
    std::shared_ptr<bst_584476esjb::Node> root;
    for(int x:{ 32, 59, 57, 71, 46, 30 }) root=bst_584476esjb::insert(root,x);
    std::cout<<"Inorder:     "; bst_584476esjb::inorder(root); std::cout<<"\n";
    std::cout<<"Level order: "; bst_584476esjb::level_order(root); std::cout<<"\n";
    return 0;
}
