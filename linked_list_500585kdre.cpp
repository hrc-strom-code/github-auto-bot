// Auto-generated: 2026-05-10 10:35:00
// Topic: Singly Linked List with Reverse
#include <iostream>
#include <memory>

namespace linked_list_500585kdre {
...
int main() {
    linked_list_500585kdre::List<int> lst;
    for(int x:{ 3, 6, 93, 37, 87, 56, 92, 60, 16 }) lst.push_back(x);
