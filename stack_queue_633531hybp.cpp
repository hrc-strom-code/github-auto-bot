// Auto-generated: 2026-05-10 10:37:13
// Topic: Stack and Circular Queue
#include <iostream>
#include <vector>
#include <stdexcept>

namespace ds_633531hybp {
...
int main() {
    ds_633531hybp::Stack<int> stk;
    for(int x:{ 81, 27, 85, 36, 23, 48, 74, 94, 35 }) stk.push(x);
    std::cout<<"Stack top: "<<stk.peek()<<" size: "<<stk.size()<<"\n";
    ds_633531hybp::CQueue<int> q(20);
    for(int x:{ 81, 27, 85, 36, 23, 48, 74, 94, 35 }) q.enqueue(x);
