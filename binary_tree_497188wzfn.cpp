...
int main() {
    std::shared_ptr<bst_497188wzfn::Node> root;
    for(int x:{ 63, 70, 62, 40, 34, 72, 90, 28 }) root=bst_497188wzfn::insert(root,x);
    std::cout<<"Inorder:     "; bst_497188wzfn::inorder(root); std::cout<<"\n";
    std::cout<<"Level order: "; bst_497188wzfn::level_order(root); std::cout<<"\n";
    return 0;
}
