// Auto-generated: 2026-05-11 11:59:44
// Topic: Singly Linked List with Reverse
#include <iostream>
#include <memory>

namespace linked_list_984085pfpw {
...
int main() {
    linked_list_984085pfpw::List<int> lst;
    for(int x:{ 54, 16, 33, 87, 90, 6, 79, 11, 33 }) lst.push_back(x);
