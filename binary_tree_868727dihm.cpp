...
int main() {
    std::shared_ptr<bst_868727dihm::Node> root;
    for(int x:{ 47, 56, 13, 50, 41, 63, 17, 42, 36, 25 }) root=bst_868727dihm::insert(root,x);
    std::cout<<"Inorder:     "; bst_868727dihm::inorder(root); std::cout<<"\n";
    std::cout<<"Level order: "; bst_868727dihm::level_order(root); std::cout<<"\n";
    return 0;
}
