...
int main() {
    std::vector<int> arr = { 30, 93, 12, 9, 82, 17, 83, 89 };
    std::cout<<"Before: "; merge_863701ngmk::print(arr);
    merge_863701ngmk::sort(arr,0,arr.size()-1);
    std::cout<<"After:  "; merge_863701ngmk::print(arr);
    return 0;
}
