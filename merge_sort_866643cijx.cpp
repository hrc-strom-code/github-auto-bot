...
int main() {
    std::vector<int> arr = { 81, 44, 1, 74, 71, 85, 69, 65 };
    std::cout<<"Before: "; merge_866643cijx::print(arr);
    merge_866643cijx::sort(arr,0,arr.size()-1);
    std::cout<<"After:  "; merge_866643cijx::print(arr);
    return 0;
}
