...
int main() {
    std::vector<int> arr = { 33, 62, 50, 23, 3, 71, 61, 26 };
    std::cout<<"Before: "; merge_496413vxdd::print(arr);
    merge_496413vxdd::sort(arr,0,arr.size()-1);
    std::cout<<"After:  "; merge_496413vxdd::print(arr);
    return 0;
}
