// Auto-generated: 2026-05-10 10:34:54
// Topic: Binary Search Tree — Insert, Search, Traversal
#include <iostream>
#include <memory>
#include <queue>

namespace bst_494926btcf {
...
int main() {
    std::shared_ptr<bst_494926btcf::Node> root;
    for(int x:{ 32, 45, 37, 36, 42, 5, 88, 78 }) root=bst_494926btcf::insert(root,x);
    std::cout<<"Inorder:     "; bst_494926btcf::inorder(root); std::cout<<"\n";
    std::cout<<"Level order: "; bst_494926btcf::level_order(root); std::cout<<"\n";
    return 0;
}
