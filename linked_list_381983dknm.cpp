// Auto-generated: 2026-05-10 10:33:01
// Topic: Singly Linked List with Reverse
#include <iostream>
#include <memory>

namespace linked_list_381983dknm {
...
int main() {
    linked_list_381983dknm::List<int> lst;
    for(int x:{ 49, 44, 57, 85, 81, 57, 53, 62, 30 }) lst.push_back(x);
