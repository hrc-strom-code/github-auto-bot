// Auto-generated: 2026-05-10 10:36:45
// Topic: Merge Sort
#include <iostream>
#include <vector>

namespace merge_605514xpxv {
...
int main() {
    std::vector<int> arr = { 45, 27, 83, 13, 88, 27, 94, 24, 33, 39 };
    std::cout<<"Before: "; merge_605514xpxv::print(arr);
    merge_605514xpxv::sort(arr,0,arr.size()-1);
    std::cout<<"After:  "; merge_605514xpxv::print(arr);
    return 0;
}
