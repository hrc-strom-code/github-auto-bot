...
int main() {
    std::vector<int> arr = { 31, 81, 79, 60, 93, 7, 59 };
    std::cout<<"Before: "; merge_500066mffq::print(arr);
    merge_500066mffq::sort(arr,0,arr.size()-1);
    std::cout<<"After:  "; merge_500066mffq::print(arr);
    return 0;
}
