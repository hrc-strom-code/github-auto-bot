...
int main() {
    ds_502921hlhk::Stack<int> stk;
    for(int x:{ 23, 64, 74, 10, 21, 62 }) stk.push(x);
    std::cout<<"Stack top: "<<stk.peek()<<" size: "<<stk.size()<<"\n";
    ds_502921hlhk::CQueue<int> q(20);
    for(int x:{ 23, 64, 74, 10, 21, 62 }) q.enqueue(x);
