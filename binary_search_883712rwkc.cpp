// Auto-generated: 2026-05-11 17:48:03
// Topic: Binary Search & Linear Search
#include <iostream>
#include <vector>
#include <algorithm>

namespace search_883712rwkc {
...
int main() {
    std::vector<int> arr = { 30, 79, 5, 60, 85, 89, 49, 46 };
    std::sort(arr.begin(),arr.end());
    int t=arr[arr.size()/2];
    std::cout<<"Sorted: "; for(int x:arr) std::cout<<x<<" "; std::cout<<"\n";
    std::cout<<"Search "<<t<<": index "<<search_883712rwkc::binary(arr,t)<<"\n";
    return 0;
}
