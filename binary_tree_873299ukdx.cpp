...
int main() {
    std::shared_ptr<bst_873299ukdx::Node> root;
    for(int x:{ 5, 33, 99, 41, 60, 8, 42, 23, 55 }) root=bst_873299ukdx::insert(root,x);
    std::cout<<"Inorder:     "; bst_873299ukdx::inorder(root); std::cout<<"\n";
    std::cout<<"Level order: "; bst_873299ukdx::level_order(root); std::cout<<"\n";
    return 0;
}
