...
int main() {
    std::vector<int> arr = { 20, 21, 58, 42, 32, 43, 59 };
    std::cout<<"Before: "; merge_502710hyug::print(arr);
    merge_502710hyug::sort(arr,0,arr.size()-1);
    std::cout<<"After:  "; merge_502710hyug::print(arr);
    return 0;
}
