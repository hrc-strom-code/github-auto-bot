// Auto-generated: 2026-05-10 10:33:49
// Topic: Binary Search Tree — Insert, Search, Traversal
#include <iostream>
#include <memory>
#include <queue>

namespace bst_429497prbc {
...
int main() {
    std::shared_ptr<bst_429497prbc::Node> root;
    for(int x:{ 77, 35, 47, 3, 42, 67, 21 }) root=bst_429497prbc::insert(root,x);
    std::cout<<"Inorder:     "; bst_429497prbc::inorder(root); std::cout<<"\n";
    std::cout<<"Level order: "; bst_429497prbc::level_order(root); std::cout<<"\n";
    return 0;
}
