// Auto-generated: 2026-05-10 10:32:25
// Topic: Binary Search & Linear Search
#include <iostream>
#include <vector>
#include <algorithm>

namespace search_345293fzbx {
...
int main() {
    std::vector<int> arr = { 60, 44, 99, 26, 56, 47, 40, 6, 23, 56 };
    std::sort(arr.begin(),arr.end());
    int t=arr[arr.size()/2];
    std::cout<<"Sorted: "; for(int x:arr) std::cout<<x<<" "; std::cout<<"\n";
    std::cout<<"Search "<<t<<": index "<<search_345293fzbx::binary(arr,t)<<"\n";
    return 0;
}
