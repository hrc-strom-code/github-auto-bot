// Auto-generated: 2026-05-11 17:17:54
// Topic: Sieve of Eratosthenes
#include <iostream>
#include <vector>
#include <cmath>

namespace primes_074541qrox {
...
int main() {
    auto primes=primes_074541qrox::sieve(45);
    std::cout<<"Primes up to 45: "; for(int p:primes) std::cout<<p<<" "; std::cout<<"\n";
    int n=8*7;
    std::cout<<"Factors of "<<n<<": ";
    for(int f:primes_074541qrox::factorize(n)) std::cout<<f<<" "; std::cout<<"\n";
    return 0;
}
