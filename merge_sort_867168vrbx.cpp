...
int main() {
    std::vector<int> arr = { 34, 14, 64, 85, 7, 63 };
    std::cout<<"Before: "; merge_867168vrbx::print(arr);
    merge_867168vrbx::sort(arr,0,arr.size()-1);
    std::cout<<"After:  "; merge_867168vrbx::print(arr);
    return 0;
}
