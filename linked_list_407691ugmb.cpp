// Auto-generated: 2026-05-10 10:33:27
// Topic: Singly Linked List with Reverse
#include <iostream>
#include <memory>

namespace linked_list_407691ugmb {
...
int main() {
    linked_list_407691ugmb::List<int> lst;
    for(int x:{ 39, 31, 61, 17, 53, 50, 37, 76 }) lst.push_back(x);
