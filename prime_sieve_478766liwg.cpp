// Auto-generated: 2026-05-10 10:34:38
// Topic: Sieve of Eratosthenes
#include <iostream>
#include <vector>
#include <cmath>

namespace primes_478766liwg {
...
int main() {
    auto primes=primes_478766liwg::sieve(46);
    std::cout<<"Primes up to 46: "; for(int p:primes) std::cout<<p<<" "; std::cout<<"\n";
    int n=11*7;
    std::cout<<"Factors of "<<n<<": ";
    for(int f:primes_478766liwg::factorize(n)) std::cout<<f<<" "; std::cout<<"\n";
    return 0;
}
