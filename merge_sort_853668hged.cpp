...
int main() {
    std::vector<int> arr = { 40, 21, 57, 17, 7, 24, 60 };
    std::cout<<"Before: "; merge_853668hged::print(arr);
    merge_853668hged::sort(arr,0,arr.size()-1);
    std::cout<<"After:  "; merge_853668hged::print(arr);
    return 0;
}
