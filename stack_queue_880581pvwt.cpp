...
int main() {
    ds_880581pvwt::Stack<int> stk;
    for(int x:{ 90, 98, 77, 27, 67, 45, 63, 66 }) stk.push(x);
    std::cout<<"Stack top: "<<stk.peek()<<" size: "<<stk.size()<<"\n";
    ds_880581pvwt::CQueue<int> q(20);
    for(int x:{ 90, 98, 77, 27, 67, 45, 63, 66 }) q.enqueue(x);
