// Auto-generated: 2026-05-10 01:21:50
// Topic: Binary Search Tree — Insert, Search, Traversal
#include <iostream>
#include <memory>
#include <queue>

namespace bst_310738sfsk {
...
int main() {
    std::shared_ptr<bst_310738sfsk::Node> root;
    for(int x:{ 86, 53, 83, 42, 90, 31, 60, 37, 92, 11 }) root=bst_310738sfsk::insert(root,x);
    std::cout<<"Inorder:     "; bst_310738sfsk::inorder(root); std::cout<<"\n";
    std::cout<<"Level order: "; bst_310738sfsk::level_order(root); std::cout<<"\n";
    return 0;
}
