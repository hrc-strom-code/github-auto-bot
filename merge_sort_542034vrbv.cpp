// Auto-generated: 2026-05-10 10:35:42
// Topic: Merge Sort
#include <iostream>
#include <vector>

namespace merge_542034vrbv {
...
int main() {
    std::vector<int> arr = { 17, 7, 55, 32, 40, 88 };
    std::cout<<"Before: "; merge_542034vrbv::print(arr);
    merge_542034vrbv::sort(arr,0,arr.size()-1);
    std::cout<<"After:  "; merge_542034vrbv::print(arr);
    return 0;
}
