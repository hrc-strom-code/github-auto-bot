...
int main() {
    std::vector<int> arr = { 85, 8, 72, 43, 40, 32, 36, 69 };
    std::cout<<"Before: "; merge_506739scqs::print(arr);
    merge_506739scqs::sort(arr,0,arr.size()-1);
    std::cout<<"After:  "; merge_506739scqs::print(arr);
    return 0;
}
