...
int main() {
    std::shared_ptr<bst_873130rtqt::Node> root;
    for(int x:{ 74, 77, 96, 15, 59, 35 }) root=bst_873130rtqt::insert(root,x);
    std::cout<<"Inorder:     "; bst_873130rtqt::inorder(root); std::cout<<"\n";
    std::cout<<"Level order: "; bst_873130rtqt::level_order(root); std::cout<<"\n";
    return 0;
}
