...
int main() {
    std::vector<int> arr = { 88, 67, 90, 37, 83, 1, 69, 80 };
    std::cout<<"Before: "; merge_864234ivnm::print(arr);
    merge_864234ivnm::sort(arr,0,arr.size()-1);
    std::cout<<"After:  "; merge_864234ivnm::print(arr);
    return 0;
}
