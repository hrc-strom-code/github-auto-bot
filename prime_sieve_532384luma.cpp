// Auto-generated: 2026-05-10 10:35:32
// Topic: Sieve of Eratosthenes
#include <iostream>
#include <vector>
#include <cmath>

namespace primes_532384luma {
...
int main() {
    auto primes=primes_532384luma::sieve(31);
    std::cout<<"Primes up to 31: "; for(int p:primes) std::cout<<p<<" "; std::cout<<"\n";
    int n=10*7;
    std::cout<<"Factors of "<<n<<": ";
    for(int f:primes_532384luma::factorize(n)) std::cout<<f<<" "; std::cout<<"\n";
    return 0;
}
